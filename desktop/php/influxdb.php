...
sendVarToJS('eqType', 'influxdb');
$eqLogics = eqLogic::byType('influxdb');
?>
...
<div class="row row-overflow">
        ...
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add">
                    <i class="fa fa-plus-circle"></i> {{Ajouter une base InfluxDB}}
                </a>
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
        <legend>{{Mes bases InfluxDB}}</legend>
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{Nom de la base InfluxDB}}</label>
                    <div class="col-sm-3">
                        <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                        <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de la base InfluxDB}}"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{influxdb param 1}}</label>
                    <div class="col-sm-3">
...
<?php include_file('desktop', 'influxdb', 'js', 'influxdb'); ?>
