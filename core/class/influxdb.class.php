...
class influxdb extends eqLogic {
    /******************************* Attributs *******************************/ 
    ...
    */
    ...
    public function initStackData() {
        nodejs::pushUpdate('influxdb::initStackDataEqLogic', array('plugin' => 'influxdb', 'action' => 'saveStack', 'callback' => 'displayEqLogic'));
    }
